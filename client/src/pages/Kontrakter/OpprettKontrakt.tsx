...
export default function OpprettKontrakt() {
                  ...
                  <div className="mt-4 flex flex-col gap-2">
                    ...
                    {kontraktData.elevFornavn && kontraktData.elevEtternavn && (
                      <PDFDownloadButton
                        ...
                        bedrift={null}
                      >
                        <button onClick={() => console.log('Last ned dokument')} className="w-full px-2 py-1 bg-red-50 hover:bg-red-100 text-red-700 rounded-md text-base font-medium transition-colors flex items-center justify-center gap-2">
