...
export default function AdminQuizKombinert_Ultimate() {
  // =====================================================================
  ...
  const [kategorier, setKategorier] = useState<Kategori[]>([
    {
      id: '1',
      navn: 'Trafikkregler',
      beskrivelse: 'Grunnleggende trafikkregler',
      farge: 'blue',
      ikon: 'BookOpenIcon',
      antallSporsmal: 450,
      ...
      <div className="p-6">
        ...
        {aktivTab === 'kategorier' && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Kategoriavministrasjon</h3>
            <p className="text-gray-600">Minimalistisk kategoristyring kommer her</p>
          </div>
        )}
        {aktivTab === 'bulk' && (
          <div className="text-center py-12">
