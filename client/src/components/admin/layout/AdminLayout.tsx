...
export const AdminLayout = ({ children }: AdminLayoutProps) => {
  ...
  const navigation = [
    ...
    { name: 'Sikkerhet', href: '/admin/security', icon: '🔒' },
    { name: 'Middleware', href: '/admin/middleware', icon: '🔧' },
    { name: 'Tjenester', href: '/admin/services', icon: '⚙️' },
    { name: 'Bedrifter', href: '/admin/bedrifter', icon: '🏢' },
    { name: 'Brukere', href: '/admin/brukere', icon: '👥' },
