...
interface KontraktModalProps {
  isOpen: boolean;
  onClose: () => void;
}

// Placeholder komponent inntil den riktige blir implementert
const KontraktModal: React.FC<KontraktModalProps> = ({ isOpen, onClose }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white px-2 py-1 rounded-lg max-w-md w-full mx-4">
        <h3 className="text-lg font-medium mb-4">Kontrakt Modal</h3>
