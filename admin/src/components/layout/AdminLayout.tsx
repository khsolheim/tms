...
export const AdminLayout = ({ children }: AdminLayoutProps) => {
  ...
  const navigation = [
    ...
    { name: 'Sikkerhet', href: '/security', icon: '🔒' },
    { name: 'Middleware', href: '/middleware', icon: '🔧' },
    { name: 'Tjenester', href: '/services', icon: '⚙️' },
    { name: 'Bedrifter', href: '/bedrifter', icon: '🏢' },
    { name: 'Brukere', href: '/brukere', icon: '👥' },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center">
                ...
                >
                  <span className="sr-only">Åpne sidebar</span>
