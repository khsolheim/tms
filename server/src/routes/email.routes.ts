...
// Send test e-post
router.post('/test-send', verifyToken, validate(testEmailSchema), asyncHandler(async (req: AuthRequest, res) => {
...
router.post('/kontrakt/:kontraktId', verifyToken, validate(sendKontraktEmailSchema), asyncHandler(async (req: AuthRequest, res) => {
...
// Send statusvarsel
router.post('/status-varsel', verifyToken, validate(sendStatusVarselSchema), asyncHandler(async (req: AuthRequest, res) => {
...
router.get('/settings', verifyToken, validate(getEmailSettingsSchema), asyncHandler(async (req: AuthRequest, res) => {
