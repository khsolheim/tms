...
router.post("/create", 
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    const { fornavn, etternavn, epost, telefon, bedriftId, passord, rolle, adresse, postnummer, poststed, klasser, kjøretøy, hovedkjøretøy } = req.body;
    ...
    const ansatt = await prisma.ansatt.create({
      data: {
        ...
        klasser: klasser || [],
        kjøretøy: kjøretøy || [],
        hovedkjøretøy: hovedkjøretøy || null
      }
    });
...
router.put("/:id", 
  ...
  asyncHandler(async (req: AuthRequest, res: Response) => {
    ...
    const { fornavn, etternavn, epost, telefon, rolle, passord, adresse, postnummer, poststed, klasser, kjøretøy, hovedkjøretøy } = req.body;
    ...
    if (kjøretøy !== undefined) updateData.kjøretøy = kjøretøy || [];
    if (hovedkjøretøy !== undefined) updateData.hovedkjøretøy = hovedkjøretøy || null;
