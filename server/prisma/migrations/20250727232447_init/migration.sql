...
-- CreateEnum
CREATE TYPE "AnsattRolle" AS ENUM ('HOVEDBRUKER', 'TRAFIKKLARER', 'ADMIN');
...
-- CreateEnum
CREATE TYPE "QuizDifficulty" AS ENUM ('LETT', 'MIDDELS', 'VANSKELIG');

-- CreateEnum
CREATE TYPE "QuizType" AS ENUM ('STANDARD', 'ADAPTIVE', 'MICRO', 'COLLABORATIVE', 'ASSESSMENT');

-- CreateEnum
CREATE TYPE "QuizMediaType" AS ENUM ('IMAGE', 'VIDEO', 'AUDIO', 'INTERACTIVE', 'NONE');

-- CreateEnum
CREATE TYPE "SecurityEventType" AS ENUM ('SUSPICIOUS_TIMING', 'TAB_SWITCH', 'COPY_PASTE', 'MULTIPLE_SESSIONS', 'BROWSER_FINGERPRINT_CHANGE', 'UNUSUAL_NAVIGATION', 'RAPID_CLICKING');
...
-- CreateEnum
CREATE TYPE "AchievementType" AS ENUM ('QUIZ_COMPLETION', 'PERFECT_SCORE', 'STREAK', 'TIME_BASED', 'CATEGORY_MASTERY', 'IMPROVEMENT', 'COLLABORATION');

-- CreateEnum
CREATE TYPE "GeografiskType" AS ENUM ('LAND', 'FYLKE', 'KOMMUNE', 'BYDEL', 'SKOLE');

-- CreateEnum
CREATE TYPE "AnnonsorType" AS ENUM ('ANNONSOR', 'SPONSOR');

-- CreateEnum
CREATE TYPE "AnnonsorStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'SUSPENDED');

-- CreateEnum
CREATE TYPE "InteraksjonsType" AS ENUM ('VISNING', 'KLIKK', 'TELEFON', 'EPOST', 'VEIBESKRIVELSE', 'EKSPANDERT');
...
CREATE TABLE "User" (
    ...
    "globalRole" "GlobalRolle" NOT NULL DEFAULT 'STANDARD_USER',
...
CREATE TABLE "QuizSporsmal" (
    ...
    "kvalitetsscore" DOUBLE PRECISION,
    "estimertTid" INTEGER,
    "opprettet" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "oppdatert" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deletedAt" TIMESTAMP(3),
...
CREATE TABLE "QuizXP" (
    ...
    CONSTRAINT "QuizXP_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "DifficultyAdjustment" (
    ...
    CONSTRAINT "DifficultyAdjustment_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "QuizRecommendation" (
    ...
    CONSTRAINT "QuizRecommendation_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "QuizCollaboration" (
    ...
    CONSTRAINT "QuizCollaboration_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SessionIntegrity" (
    ...
    CONSTRAINT "SessionIntegrity_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "SystemConfig" (
    ...
    "fakturaRente" DOUBLE PRECISION NOT NULL DEFAULT 8.5,
...
CREATE TABLE "GeografiskEnhet" (
    ...
    CONSTRAINT "GeografiskEnhet_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "AnnonsorSponsor" (
    ...
    "startDato" TIMESTAMP(3) NOT NULL,
    "sluttDato" TIMESTAMP(3),
    "status" "AnnonsorStatus" NOT NULL DEFAULT 'PENDING',
    "godkjentAv" INTEGER,
    "godkjentDato" TIMESTAMP(3),
    "avvistGrunn" TEXT,
    "budsjett" DOUBLE PRECISION,
    "kostnadPerVisning" DOUBLE PRECISION,
    "kostnadPerKlikk" DOUBLE PRECISION,
    "opprettet" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "oppdatert" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "deletedAt" TIMESTAMP(3),
    "deletedBy" INTEGER,
    ...
    CONSTRAINT "AnnonsorSponsor_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Annonse" (
    ...
    CONSTRAINT "Annonse_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "AnnonseTargeting" (
    ...
    CONSTRAINT "AnnonseTargeting_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "AnnonseStatistikk" (
    ...
    CONSTRAINT "AnnonseStatistikk_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "AnnonseInteraksjon" (
    ...
    "annonseId" INTEGER NOT NULL,
    "elevId" INTEGER,
    "interaksjonsType" "InteraksjonsType" NOT NULL,
    "tidspunkt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "ipAdresse" TEXT,
    "userAgent" TEXT,
    "referrer" TEXT,

    CONSTRAINT "AnnonseInteraksjon_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BedriftPageAccess" (
    ...
    CONSTRAINT "BedriftPageAccess_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "PageAccessHistory" (
    ...
    CONSTRAINT "PageAccessHistory_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "BedriftSubscription" (
    ...
    CONSTRAINT "BedriftSubscription_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "QuizSession" ADD CONSTRAINT "QuizSession_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuizSession" ADD CONSTRAINT "QuizSession_kategoriId_fkey" FOREIGN KEY ("kategoriId") REFERENCES "QuizKategori"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "QuizSessionAnswer" ADD CONSTRAINT "QuizSessionAnswer_questionId_fkey" FOREIGN KEY ("questionId") REFERENCES "QuizSporsmal"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserAchievement" ADD CONSTRAINT "UserAchievement_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuizXP" ADD CONSTRAINT "QuizXP_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DifficultyAdjustment" ADD CONSTRAINT "DifficultyAdjustment_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DifficultyAdjustment" ADD CONSTRAINT "DifficultyAdjustment_kategoriId_fkey" FOREIGN KEY ("kategoriId") REFERENCES "QuizKategori"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "UserPreferences" ADD CONSTRAINT "UserPreferences_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuizRecommendation" ADD CONSTRAINT "QuizRecommendation_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuizRecommendation" ADD CONSTRAINT "QuizRecommendation_kategoriId_fkey" FOREIGN KEY ("kategoriId") REFERENCES "QuizKategori"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuizCollaboration" ADD CONSTRAINT "QuizCollaboration_ownerId_fkey" FOREIGN KEY ("ownerId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuizVersion" ADD CONSTRAINT "QuizVersion_collaborationId_fkey" FOREIGN KEY ("collaborationId") REFERENCES "QuizCollaboration"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "QuizVersion" ADD CONSTRAINT "QuizVersion_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SecurityEvent" ADD CONSTRAINT "SecurityEvent_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "QuizSession"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SecurityEvent" ADD CONSTRAINT "SecurityEvent_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SecurityEvent" ADD CONSTRAINT "SecurityEvent_reviewedBy_fkey" FOREIGN KEY ("reviewedBy") REFERENCES "Ansatt"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PerformanceMetrics" ADD CONSTRAINT "PerformanceMetrics_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PerformanceMetrics" ADD CONSTRAINT "PerformanceMetrics_kategoriId_fkey" FOREIGN KEY ("kategoriId") REFERENCES "QuizKategori"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LearningPattern" ADD CONSTRAINT "LearningPattern_userId_fkey" FOREIGN KEY ("userId") REFERENCES "Ansatt"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "GeografiskEnhet" ADD CONSTRAINT "GeografiskEnhet_parentId_fkey" FOREIGN KEY ("parentId") REFERENCES "GeografiskEnhet"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AnnonsorSponsor" ADD CONSTRAINT "AnnonsorSponsor_bedriftId_fkey" FOREIGN KEY ("bedriftId") REFERENCES "Bedrift"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AnnonsorSponsor" ADD CONSTRAINT "AnnonsorSponsor_godkjentAv_fkey" FOREIGN KEY ("godkjentAv") REFERENCES "Ansatt"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Annonse" ADD CONSTRAINT "Annonse_annonsorId_fkey" FOREIGN KEY ("annonsorId") REFERENCES "AnnonsorSponsor"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AnnonseTargeting" ADD CONSTRAINT "AnnonseTargeting_annonseId_fkey" FOREIGN KEY ("annonseId") REFERENCES "Annonse"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AnnonseTargeting" ADD CONSTRAINT "AnnonseTargeting_geografiskId_fkey" FOREIGN KEY ("geografiskId") REFERENCES "GeografiskEnhet"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AnnonseTargeting" ADD CONSTRAINT "AnnonseTargeting_spesifikkeSkoleId_fkey" FOREIGN KEY ("spesifikkeSkoleId") REFERENCES "Bedrift"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AnnonseStatistikk" ADD CONSTRAINT "AnnonseStatistikk_annonseId_fkey" FOREIGN KEY ("annonseId") REFERENCES "Annonse"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AnnonseInteraksjon" ADD CONSTRAINT "AnnonseInteraksjon_annonseId_fkey" FOREIGN KEY ("annonseId") REFERENCES "Annonse"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AnnonseInteraksjon" ADD CONSTRAINT "AnnonseInteraksjon_elevId_fkey" FOREIGN KEY ("elevId") REFERENCES "Elev"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BedriftPageAccess" ADD CONSTRAINT "BedriftPageAccess_bedriftId_fkey" FOREIGN KEY ("bedriftId") REFERENCES "Bedrift"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BedriftPageAccess" ADD CONSTRAINT "BedriftPageAccess_pageKey_fkey" FOREIGN KEY ("pageKey") REFERENCES "PageDefinition"("pageKey") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BedriftPageAccess" ADD CONSTRAINT "BedriftPageAccess_enabledBy_fkey" FOREIGN KEY ("enabledBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PageAccessHistory" ADD CONSTRAINT "PageAccessHistory_bedriftId_fkey" FOREIGN KEY ("bedriftId") REFERENCES "Bedrift"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PageAccessHistory" ADD CONSTRAINT "PageAccessHistory_performedBy_fkey" FOREIGN KEY ("performedBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BedriftSubscription" ADD CONSTRAINT "BedriftSubscription_bedriftId_fkey" FOREIGN KEY ("bedriftId") REFERENCES "Bedrift"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BedriftSubscription" ADD CONSTRAINT "BedriftSubscription_planId_fkey" FOREIGN KEY ("planId") REFERENCES "SubscriptionPlan"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SubscriptionHistory" ADD CONSTRAINT "SubscriptionHistory_bedriftId_fkey" FOREIGN KEY ("bedriftId") REFERENCES "Bedrift"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "SubscriptionHistory" ADD CONSTRAINT "SubscriptionHistory_oldPlanId_fkey" FOREIGN KEY ("oldPlanId") REFERENCES "SubscriptionPlan"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SubscriptionHistory" ADD CONSTRAINT "SubscriptionHistory_newPlanId_fkey" FOREIGN KEY ("newPlanId") REFERENCES "SubscriptionPlan"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SubscriptionHistory" ADD CONSTRAINT "SubscriptionHistory_performedBy_fkey" FOREIGN KEY ("performedBy") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
