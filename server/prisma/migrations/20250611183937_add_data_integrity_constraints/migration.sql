...
CREATE INDEX IF NOT EXISTS "idx_kontrakt_personnummer_validation" ON "Kontrakt" ("elevPersonnummer") WHERE "isDeleted" = false;
CREATE INDEX IF NOT EXISTS "idx_elev_personnummer_validation" ON "Elev" ("personnummer") WHERE "isDeleted" = false;
CREATE INDEX IF NOT EXISTS "idx_bedrift_orgnummer_validation" ON "Bedrift" ("orgNummer") WHERE "isDeleted" = false;
